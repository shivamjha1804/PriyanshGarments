  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full text-white px-16 sm:px-20 lg:px-25 lg:pt-7">
        {/* Heading */}
        <h1 className="text-2xl sm:text-4xl lg:text-5xl w-3/4 sm:w-full font-extrabold leading-tight mb-6">
        ...
        {/* Paragraph */}
        <p className="text-lg sm:text-xl lg:text-sm mb-8 max-w-lg leading-relaxed">
        ...
        {/* Button */}
        <button className="px-6 py-3 bg-red-600 text-white font-bold text-sm lg:text-sm  hover:bg-red-700 transition duration-300 shadow-lg">
          VIEW PRODUCTS
        </button>
      </div>
    </div>
